...
<body>
  ...
  <div class="p-6 bg-gray-700 text-white relative top-[4rem] h-[92vh]">
    <div class="flex items-center gap-6 justify-center">
        ...
        <a href="#" class="text-xl font-bold mb-6 text-center hover:text-[#8707ff] hover:underline underline-offset-4">Manage Appointment</a>
    </div>
              ...
              while($row = mysqli_fetch_array($response)) {
                  ...
                  echo "<tr class='border-b border-gray-200 hover:bg-gray-100'>
                          ...
                          <td class='py-3 px-6 text-center'>
                            ...
                            <a href='reschedule.php?id={$id}' class='bg-[#20C997] hover:bg-[#008080] text-white px-4 py-1 rounded-md' >Reschedule</a>
                          </td>
                        </tr>";
              }
          }
