          ...
          if(isset($_SESSION['doc'])){
              ...
              <li>
                <a
                  ...
                  class="flex gap-2 items-center font-bold hover:text-gray-400 hover:underline underline-offset-4 transition-all duration-500"
                  ><i class="fa-solid fa-user-doctor"></i>'.$user.'</a
                >
              </li>
              <li>
                <a
      ...
      >
        <?php
            if(isset($_SESSION['doc'])){
                ...
                <a  class="block text-lg hover:text-gray-600"><i class="fa-solid fa-user-doctor"></i>'.$user.'</a>
